      ...
      <div class="w-20 bg-white/80 backdrop-blur-md border-r border-slate-200 flex flex-col items-center py-8 space-y-4">
        <button
          ...
          :class="`w-12 h-12 rounded-xl flex flex-col items-center justify-center transition-all duration-200 ${
            activeTab === 'account'
              ? 'bg-gradient-to-br from-teal-50 to-emerald-50 text-teal-600 border border-teal-100 shadow-sm'
      ...
      <div class="flex-1 overflow-y-auto bg-slate-50">
        <div class="max-w-6xl mx-auto px-8 py-10">
          ...
          <div class="grid grid-cols-3 gap-6 mb-8">
            <div class="bg-gradient-to-br from-white to-teal-50/30 border border-slate-200/60 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow group">
          ...
          <div class="grid grid-cols-2 gap-6 mb-8">
            <div class="bg-white border border-slate-200/60 rounded-xl p-6 shadow-sm hover:border-teal-300 hover:shadow-md hover:bg-teal-50/30 transition-all cursor-pointer group">
              <div class="flex items-start space-x-4">
                <div class="w-12 h-12 bg-teal-50 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-teal-600 transition-colors duration-300">
                  <i class="ri-shield-check-line text-teal-600 text-xl group-hover:text-white transition-colors duration-300"></i>
                </div>
                <div>
                  <h3 class="text-lg font-bold text-slate-800 mb-1 group-hover:text-teal-600 transition-colors">安全保障</h3>
                  <p class="text-slate-500 text-sm leading-relaxed">基于 RPA 技术模拟真人操作，确保账号安全稳定，降低封号风险。</p>
                </div>
              </div>
            </div>

            <div class="bg-white border border-slate-200/60 rounded-xl p-6 shadow-sm hover:border-emerald-300 hover:shadow-md hover:bg-emerald-50/30 transition-all cursor-pointer group">
              <div class="flex items-start space-x-4">
            ...
            <div class="bg-white border border-slate-200/60 rounded-xl p-6 shadow-sm hover:border-cyan-300 hover:shadow-md hover:bg-cyan-50/30 transition-all cursor-pointer group">
              <div class="flex items-start space-x-4">
            ...
            <div class="bg-white border border-slate-200/60 rounded-xl p-6 shadow-sm hover:border-teal-300 hover:shadow-md hover:bg-teal-50/30 transition-all cursor-pointer group">
              <div class="flex items-start space-x-4">
                <div class="w-12 h-12 bg-teal-50 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-teal-600 transition-colors duration-300">
                  <i class="ri-wechat-line text-teal-600 text-xl group-hover:text-white transition-colors duration-300"></i>
                </div>
                <div>
                  <h3 class="text-lg font-bold text-slate-800 mb-1 group-hover:text-teal-600 transition-colors">朋友圈营销</h3>
          ...
          <div class="flex items-center justify-center space-x-4 mt-8">
            <button class="px-6 py-2.5 bg-gradient-to-r from-teal-500 to-emerald-500 text-white rounded-lg font-medium shadow-md shadow-teal-500/20 hover:from-teal-600 hover:to-emerald-600 hover:shadow-lg transition-all whitespace-nowrap flex items-center space-x-2 text-sm">
              <i class="ri-service-line text-base"></i>
              <span>专属客服</span>
            </button>
            
            <button class="px-6 py-2.5 bg-white text-slate-700 rounded-lg font-medium shadow-sm hover:shadow-md hover:text-teal-600 hover:border-teal-200 transition-all border border-slate-200 whitespace-nowrap flex items-center space-x-2 text-sm">
