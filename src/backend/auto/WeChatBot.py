...
from auto.pyweixin.Uielements import Main_window, SideBar, Lists
...
class WeChatBot:
    ...
    @staticmethod
    def pull_messages(friend:str,myname:str,number:int,search_pages:int=None,is_maximize:bool=None,close_weixin:bool=None)->list[str]:
        '''
