...
class MongoDBConnection:
    ...
    async def _connect(self):
        ...
        try:
            ...
            logger.info(f"[MongoDBConnection] Connected to {host}:{port}/{db_name}")
        except Exception as e:
            logger.error(f"[MongoDBConnection] Connection failed: {e}")
            raise
    ...
    async def close(self):
        ...
        if self._client is not None:
            ...
            self._client = None
            self._db = None
            logger.info("[MongoDBConnection] Connection closed")
...
class MongoDBStoreBase:
    ...
    async def save_or_update(self, collection_suffix: str, query: Dict, data: Dict) -> bool:
        ...
        try:
            ...
            logger.error(f"[MongoDBStoreBase] Save failed ({self.collection_prefix}_{collection_suffix}): {e}")
            return False
    ...
    async def find_one(self, collection_suffix: str, query: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            logger.error(f"[MongoDBStoreBase] Find one failed ({self.collection_prefix}_{collection_suffix}): {e}")
            return None
    ...
    async def find_many(self, collection_suffix: str, query: Dict, limit: int = 0) -> List[Dict]:
        ...
        try:
            ...
            logger.error(f"[MongoDBStoreBase] Find many failed ({self.collection_prefix}_{collection_suffix}): {e}")
            return []
    ...
    async def create_index(self, collection_suffix: str, keys: List[tuple], unique: bool = False):
        ...
        try:
            ...
            logger.info(f"[MongoDBStoreBase] Index created on {self.collection_prefix}_{collection_suffix}")
        except Exception as e:
            logger.error(f"[MongoDBStoreBase] Create index failed: {e}")
